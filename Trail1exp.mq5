...
#include <Trail1sample_trailingstop.mqh> // include Trailing Stop class
      ...
      if(Buy_Condition_3 && Buy_Condition_4)
        {
         ...
         //--- send order
         //>>>
         Print("Opening buy at price: " + mrequest.price + ", SL: " + mrequest.sl + ", TP: " + mrequest.tp);
         //>>>
      ...
      if(Sell_Condition_3 && Sell_Condition_4)
        {
         ...
         //--- send order
         //>>>
         Print("Opening sell at price: " + mrequest.price + ", SL: " + mrequest.sl + ", TP: " + mrequest.tp);
         //>>>
         OrderSend(mrequest,mresult);
         //--- analyze the return code of trade server
